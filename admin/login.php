            ...
            <div class="login-content">
               <div class="login-form mt-150">
                ...
                if(isset($_POST['submit'])){
                  ...
                  $meta_sql=mysqli_query($connect,"SELECT * FROM `login_portfolio_sazzad` WHERE  email='$email' and password='$password' and name='$name'");
                  $sql=mysqli_num_rows($meta_sql);
                  if($sql>0){
                    ...
                    echo "pleace enter carrect email or password or name..!";
                  }
                 }
                 ?>
               </div>
